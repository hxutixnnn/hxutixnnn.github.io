...
- Keep core apps in the compile-time catalogue/loader path under `src/apps/`. External apps must remain reviewed HTTPS links—no runtime repository scanning, remote modules, or unreviewed iframes.
