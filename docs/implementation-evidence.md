...
**Measured:** 2026-08-01 on the production static build (`pnpm build`).
...
| Delivery        | Gatsby build; no repository CI/browser suite                                                 | 35 generated HTML files, 34 canonical HTML routes checked, RSS and modern/legacy sitemaps, PR validation, and GitHub Pages artifact workflow |
