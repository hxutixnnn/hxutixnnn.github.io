...
const popupClassName =
  "tienos-menu-popup min-w-60 max-w-[calc(100vw-16px)] origin-[var(--transform-origin)] overflow-hidden rounded-[var(--tienos-radius-menu)] border border-white/25 [background:linear-gradient(145deg,rgb(255_255_255/.18),transparent_42%),var(--tienos-color-menu)] p-[var(--tienos-space-1)] shadow-[0_22px_50px_rgb(0_0_0/.3),inset_0_1px_rgb(255_255_255/.25),inset_0_-1px_rgb(0_0_0/.12)] backdrop-blur-[24px] backdrop-saturate-[1.35] data-[starting-style]:[transform:scale(.96)_translateY(-4px)] data-[starting-style]:opacity-0 data-[ending-style]:[transform:scale(.96)_translateY(-4px)] data-[ending-style]:opacity-0 data-[ending-style]:transition-[opacity,transform] data-[ending-style]:[transition-duration:var(--tienos-motion-fast),var(--tienos-motion-standard)] data-[ending-style]:[transition-timing-function:ease,ease] contrast-more:border-[var(--tienos-color-border)] contrast-more:[background:var(--tienos-color-menu)] [@media(prefers-reduced-transparency:reduce)]:[background:var(--tienos-color-menu)] [@media(prefers-reduced-transparency:reduce)]:backdrop-filter-none motion-reduce:data-[starting-style]:transform-none motion-reduce:data-[ending-style]:transform-none motion-reduce:data-[ending-style]:transition-none [@media(forced-colors:active)]:border-[CanvasText] [@media(forced-colors:active)]:[background:Canvas] [@media(forced-colors:active)]:shadow-none [@media(forced-colors:active)]:backdrop-filter-none";
