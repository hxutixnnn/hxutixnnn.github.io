...
const itemClassName =
  "tienos-menu-item group flex min-h-7 w-full cursor-default items-center gap-3 rounded-[var(--tienos-radius-menu-item)] px-2 py-1 text-left text-[var(--tienos-color-text-primary)] transition-[background-color] duration-[var(--tienos-motion-fast)] ease-[ease] hover:not-data-disabled:bg-[var(--tienos-color-accent)] hover:not-data-disabled:text-[var(--tienos-color-text-on-accent)] data-[disabled]:text-[var(--tienos-color-text-tertiary)] data-[highlighted]:bg-[var(--tienos-color-accent)] data-[highlighted]:text-[var(--tienos-color-text-on-accent)] data-[highlighted]:outline-none data-[highlighted]:focus-visible:outline-2 data-[highlighted]:focus-visible:-outline-offset-2 data-[highlighted]:focus-visible:outline-[var(--tienos-color-focus-on-accent)] contrast-more:shadow-[inset_0_0_0_1px_var(--tienos-color-border)] contrast-more:focus-visible:outline-2 contrast-more:focus-visible:-outline-offset-2 contrast-more:focus-visible:outline-[var(--tienos-color-focus)] [@media(forced-colors:active)]:[forced-color-adjust:none] [@media(forced-colors:active)]:data-[highlighted]:focus-visible:!outline-[var(--tienos-color-focus-on-accent)]";
const popupClassName =
  "tienos-menu-popup min-w-60 max-w-[calc(100vw-16px)] origin-[var(--transform-origin)] overflow-hidden rounded-[var(--tienos-radius-menu)] border border-white/30 [background:linear-gradient(145deg,rgb(255_255_255/.22),transparent_44%),var(--tienos-color-menu)] p-[var(--tienos-space-1)] shadow-[0_24px_54px_rgb(0_0_0/.34),0_5px_16px_rgb(0_0_0/.12),inset_0_1px_rgb(255_255_255/.32),inset_0_-1px_rgb(0_0_0/.14)] backdrop-blur-[18px] backdrop-saturate-[1.5] data-[starting-style]:[transform:scale(.96)_translateY(-4px)] data-[starting-style]:opacity-0 data-[ending-style]:[transform:scale(.96)_translateY(-4px)] data-[ending-style]:opacity-0 data-[ending-style]:transition-[opacity,transform] data-[ending-style]:[transition-duration:var(--tienos-motion-fast),var(--tienos-motion-standard)] data-[ending-style]:[transition-timing-function:ease,ease] contrast-more:border-[var(--tienos-color-border)] contrast-more:[background:var(--tienos-color-menu)] [@media(prefers-reduced-transparency:reduce)]:[background:var(--tienos-color-menu)] [@media(prefers-reduced-transparency:reduce)]:backdrop-filter-none motion-reduce:data-[starting-style]:transform-none motion-reduce:data-[ending-style]:transform-none motion-reduce:data-[ending-style]:transition-none [@media(forced-colors:active)]:border-[CanvasText] [@media(forced-colors:active)]:[background:Canvas] [@media(forced-colors:active)]:shadow-none [@media(forced-colors:active)]:backdrop-filter-none";
const separatorClassName =
  "my-0.5 h-px border-0 bg-[var(--tienos-color-separator)] [@media(forced-colors:active)]:[forced-color-adjust:none]";
