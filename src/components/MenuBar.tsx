...
const separatorClassName =
  "my-0.5 h-px border-0 bg-[var(--tienos-color-menu-separator)] [forced-color-adjust:none] [@media(forced-colors:active)]:border-t [@media(forced-colors:active)]:border-[CanvasText] [@media(forced-colors:active)]:bg-transparent";
