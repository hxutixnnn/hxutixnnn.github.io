...
const itemClassName =
  "tienos-menu-item group flex min-h-7 w-full cursor-default items-center gap-3 rounded-[var(--tienos-radius-menu-item)] px-2 py-1 text-left text-[var(--tienos-color-text-primary)] transition-colors duration-[var(--tienos-motion-fast)] hover:not-data-disabled:bg-[var(--tienos-color-accent)] hover:not-data-disabled:text-[var(--tienos-color-text-on-accent)] data-[disabled]:text-[var(--tienos-color-text-tertiary)] data-[highlighted]:bg-[var(--tienos-color-accent)] data-[highlighted]:text-[var(--tienos-color-text-on-accent)] data-[highlighted]:outline-none data-[highlighted]:focus-visible:outline-2 data-[highlighted]:focus-visible:-outline-offset-2 data-[highlighted]:focus-visible:outline-[var(--tienos-color-focus-on-accent)] contrast-more:shadow-[inset_0_0_0_1px_var(--tienos-color-border)] contrast-more:focus-visible:outline-2 contrast-more:focus-visible:-outline-offset-2 contrast-more:focus-visible:outline-[var(--tienos-color-focus)] [@media(forced-colors:active)]:data-[highlighted]:focus-visible:!outline-[var(--tienos-color-focus-on-accent)]";
const popupClassName =
  "tienos-menu-popup min-w-60 origin-[var(--transform-origin)] overflow-hidden rounded-[var(--tienos-radius-menu)] border border-[var(--tienos-color-border)] bg-[var(--tienos-color-menu)] p-[var(--tienos-space-1)] shadow-[0_22px_50px_rgb(0_0_0/0.3),inset_0_1px_rgb(255_255_255/0.12)] backdrop-blur-[24px] backdrop-saturate-[1.3] data-[starting-style]:translate-y-[-4px] data-[starting-style]:scale-[.96] data-[starting-style]:opacity-0 data-[ending-style]:translate-y-[-4px] data-[ending-style]:scale-[.96] data-[ending-style]:opacity-0 data-[ending-style]:transition-[opacity,transform] data-[ending-style]:[transition-duration:var(--tienos-motion-fast),var(--tienos-motion-standard)] [@media(prefers-reduced-transparency:reduce)]:backdrop-filter-none";
