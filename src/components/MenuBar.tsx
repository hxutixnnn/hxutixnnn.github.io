...
const itemClassName =
  "tienos-menu-item group flex min-h-7 w-full cursor-default items-center gap-3 rounded-[var(--tienos-radius-menu-item)] px-2 py-1 text-left text-[var(--tienos-color-text-primary)] transition-colors duration-[var(--tienos-motion-fast)] hover:not-data-disabled:bg-[var(--tienos-color-accent)] hover:not-data-disabled:text-[var(--tienos-color-text-on-accent)] data-[disabled]:text-[var(--tienos-color-text-tertiary)] data-[highlighted]:bg-[var(--tienos-color-accent)] data-[highlighted]:text-[var(--tienos-color-text-on-accent)] data-[highlighted]:outline-none data-[highlighted]:focus-visible:outline-2 data-[highlighted]:focus-visible:-outline-offset-2 data-[highlighted]:focus-visible:outline-[var(--tienos-color-focus-on-accent)] contrast-more:shadow-[inset_0_0_0_1px_var(--tienos-color-border)] contrast-more:focus-visible:outline-2 contrast-more:focus-visible:-outline-offset-2 contrast-more:focus-visible:outline-[var(--tienos-color-focus)]";
